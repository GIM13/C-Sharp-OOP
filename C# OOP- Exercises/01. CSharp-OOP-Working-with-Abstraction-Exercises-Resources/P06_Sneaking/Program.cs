...
namespace P06_Sneaking
{
    class Sneaking
    {
        ...
        static void Main()
        {
            ...
            int[] samPosition = PositioningSam();

            for (int i = 0; i < moves.Length; i++)
            {
                ArrangementRoom();

                int[] getEnemy = MoveEnemy(samPosition);

                EnemyKillsSam(samPosition, getEnemy);

                MoveSam(moves, samPosition, i, getEnemy);

                NikoladzeKilled(samPosition, getEnemy);
            }
        }

        private static void EnemyKillsSam(int[] samPosition, int[] getEnemy)
        {
        ...
        private static int[] MoveEnemy(int[] samPosition)
        {
        ...
        private static void MoveSam(char[] moves, int[] samPosition, int i, int[] getEnemy)
        {
        ...
        private static void ArrangementRoom()
        {
            for (int row = 0; row < room.Length; row++)
            {
                for (int col = 0; col < room[row].Length; col++)
        ...
        private static void NikoladzeKilled(int[] samPosition, int[] getEnemy)
        {
        ...
        private static int[] PositioningSam()
        {
        ...
        private static void CreatesRoom()
        {
